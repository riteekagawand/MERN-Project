...
const Register = () => {
  ...
  return (<div className="flex h-screen justify-center items-center bg-[#989ea6]">
    {/* Outer Container */}
    <div className="h-[600px] flex w-[1000px]">
      {/* Registration Form Container */}
      <div className="w-3/5 bg-white flex justify-center items-center rounded-l-3xl">
        <div className="w-full max-w-xs">
          <form className="bg-white ml-[-40px] rounded px-8 pt-6 pb-8 mt-[16px] mb-4 h-[600px] w-[400px]" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="relative bg-gradient-to-r from-[#6c60f1] to-[#e971d6] text-white text-[20px] font-bold py-2 px-4 h-[40px] w-[320px] rounded-3xl flex justify-center items-center focus:outline-none focus:shadow-outline overflow-hidden transition-all duration-300"
            >
              <span className="absolute top-0 left-0 w-full h-full bg-black transition-transform duration-300 transform scale-x-0 hover:scale-x-100"></span>
